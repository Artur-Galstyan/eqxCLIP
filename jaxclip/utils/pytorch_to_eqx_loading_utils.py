...
def get_attrs_to_delete():
    ...
    attrs_to_delete.append("visual.layer1.0.downsample.1.num_batches_tracked")
    ...
    attrs_to_delete.append("visual.layer2.0.downsample.1.num_batches_tracked")
    ...
    attrs_to_delete.append("visual.layer3.0.downsample.1.num_batches_tracked")
    ...
    attrs_to_delete.append("visual.layer4.0.downsample.1.num_batches_tracked")
...
def load_model_from_state_dict(state_dict: dict, clip: PyTree) -> PyTree:
...
def rename_transformer_resblocks_mlp(mapping, i):
    mapping = rename_mapping_key(
        mapping,
        f"transformer.resblocks.{i}.mlp.c_fc.weight",
        f"transformer.resblocks.{i}.mlp.0.weight",
    )
    mapping = rename_mapping_key(
        mapping,
        f"transformer.resblocks.{i}.mlp.c_fc.bias",
        f"transformer.resblocks.{i}.mlp.0.bias",
    )
    mapping = rename_mapping_key(
        mapping,
        f"transformer.resblocks.{i}.mlp.c_proj.weight",
        f"transformer.resblocks.{i}.mlp.2.weight",
    )
    mapping = rename_mapping_key(
        mapping,
        f"transformer.resblocks.{i}.mlp.c_proj.bias",
        f"transformer.resblocks.{i}.mlp.2.bias",
    )
    return mapping
